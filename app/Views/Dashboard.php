                        ...
                        <?php foreach ($matkul as $mk) : ?>
                            <div class="card" style="width: 16rem;">
                                ...
                                <dive class="card-body">
                                    <h5 class="card-title"><?php echo $mk->nama_matkul ?></5> title</h5>
                                    <small><?php echo $mk->keterangan ?></small>
                                    <small><?php echo $mk->kategori?></small>
                                    <small><?php echo $mk->sks?></small>
                                    <p class="card-text">Jika ingin mengambil mata kuliah silahkan klik button dibawah ini.</p>
                                    <a href="#" class="btn btn-primary">Ambil Mata kuliah</a>
